 FREEZE+PRESS is f/l/os software-driven small press -> https://freeze.sh
 ------------------------------------------------------------------------

 here: collect source/working files


 ------------------------------------------------------------------------
 Copyright (c) 2022 Christoph Haag et al.
 ------------------------------------------------------------------------
 ...
 -------------------------------------------------------------------------
     ...
     : --------------------------------------------------------------:
     |    the physical process of a liquid turning into a solid      |
     |     the halting of all movement in a clever position          |
